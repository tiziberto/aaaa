...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errores)) {
        ...
        // Procesa los datos
        $sql = "INSERT INTO tabla_usuarios (nombre, apellido, contraseña, documento, fecha_nacimiento, provincia) VALUES ('$nombre', '$apellido', '$contraseña', '$documento', '$fecha_nacimiento', '$provincia')";
